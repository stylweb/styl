<section id='contact'>
    <h3>Contato</h3>
    <form id='contact-styl' name="contact" class='content' method="post" value="" action="/webformmailer.php">
        <input id='contact-styl-name' type="text" placeholder="Nome" name="name" value=""/>
